...
def get_network(type, placeholder_input, sess_for_load=None, trainable=True):
    if type == "mobilenet":
        ...
        pretrain_path = (
            "pretrained/mobilenet_v1_0.75_224_2017_06_14/mobilenet_v1_0.75_224.ckpt"
        )
        ...
        pretrain_path = (
            "pretrained/mobilenet_v1_1.0_224_2017_06_14/mobilenet_v1_1.0_224.ckpt"
        )
        last_layer = "MConv_Stage6_L{aux}_5"
        ...
        "mobilenet_v2_w1.4_r1.0",
        "mobilenet_v2_large",
        "mobilenet_v2_large_quantize",
    ]:  # m_v2_large
        net = Mobilenetv2Network(
            {"image": placeholder_input},
            conv_width=1.4,
            conv_width2=1.0,
            trainable=trainable,
        ...
        net = Mobilenetv2Network(
            {"image": placeholder_input}, conv_width=1.4, trainable=trainable
        )
        pretrain_path = "pretrained/mobilenet_v2_1.4_224/mobilenet_v2_1.4_224.ckpt"
        last_layer = "MConv_Stage6_L{aux}_5"
    elif type == "mobilenet_v2_1.0":
        net = Mobilenetv2Network(
            {"image": placeholder_input}, conv_width=1.0, trainable=trainable
        )
        pretrain_path = "pretrained/mobilenet_v2_1.0_224/mobilenet_v2_1.0_224.ckpt"
        last_layer = "MConv_Stage6_L{aux}_5"
    elif type == "mobilenet_v2_0.75":
        net = Mobilenetv2Network(
            {"image": placeholder_input}, conv_width=0.75, trainable=trainable
        )
        pretrain_path = "pretrained/mobilenet_v2_0.75_224/mobilenet_v2_0.75_224.ckpt"
        last_layer = "MConv_Stage6_L{aux}_5"
    elif type == "mobilenet_v2_0.5":
        net = Mobilenetv2Network(
            {"image": placeholder_input}, conv_width=0.5, trainable=trainable
        )
        pretrain_path = "pretrained/mobilenet_v2_0.5_224/mobilenet_v2_0.5_224.ckpt"
        last_layer = "MConv_Stage6_L{aux}_5"
